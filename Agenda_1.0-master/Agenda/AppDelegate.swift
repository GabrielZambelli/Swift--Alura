...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //metodo na qual sera executado apos seleciona a opção no shortcut
    func application(_ application: UIApplication, performActionFor shortcutItem: UIApplicationShortcutItem, completionHandler: @escaping (Bool) -> Void) {
        //verificar se possui o tipo selecionado no enum
        if let tipo = TipoDeShortcut(rawValue: shortcutItem.type){
            ...
            case .cadastrarAluno:
                ...
                //não possuimos acesso ao navigation controler, iremos recuperar.
                let navigation = UIApplication.shared.windows.first{$0.isKeyWindow}?.rootViewController as? UINavigationController
