...
class AvaliadorTests: XCTestCase {
    ...
    //Metodo chamado antes de executar os testes
    override func setUp() {
        super.setUp()
    ...
    //Metodo que é chamado apos o termino dos testes
    ...
    func testDeveEncontrarOsTresMaioresLances() {        
        ...
        //Em uma lista sempre avaliar a quantidade de linhas e o conteudo
    ...
    //teste de metodo que retorna exceções
